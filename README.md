...
[![Docs](https://github.com/joa-quim/GMTF3D.jl/actions/workflows/Docs.yml/badge.svg?branch=master)](https://github.com/joa-quim/GMTF3D.jl/actions/workflows/Docs.yml?query=branch%3Amaster)
...
GMTF3D.jl turns GMT data — grids, images, point-cloud datasets and Faces–Vertices
...
1. Make sure you have previously installed [F3D.jl](https://github.com/GenericMappingTools/GMT.jl)
1. In the Julia REPL do:
    ```
    ] add https://github.com/joa-quim/GMTF3D.jl
    ```
...
f3dview(peaks(120))                         # a coloured terrain surface
...
G = grdcut("@earth_relief_02m", region=(-12,0,35,45))
